# No dey give am big title when nothing has been done -- show workings first -- ... can you send me small data to start with? I really want to try out Bayes Net with this
